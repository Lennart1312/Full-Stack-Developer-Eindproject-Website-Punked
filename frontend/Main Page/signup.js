// signup.js - backend integrated for second signup page (Sign Up2.html)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('register-form').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!loginRes.ok) {
                return alert('Login after signup failed.');
            }
            ...
            // Step 4: Optionally load user’s cart from backend
            window.cartItems = [];
